    ...
    <section className="py-20 bg-gray-50/50">
      <div className="container mx-auto px-4">
        <AnimatedElement animationType="fadeInUp" className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground">Discover our most popular and unique tour experiences</p>
        </AnimatedElement>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          {featuredTours.map((tour, index) => (
            ...
            >
              <Card 
                className="relative overflow-hidden glass-card hover:-translate-y-2 transition-all duration-300 cursor-pointer"
              ...
              >
                ...
                <CardContent className="p-6">
                  ...
                  <p className="text-muted-foreground line-clamp-2 mb-4">{tour.description}</p>
